...
namespace radj307.IconExtractor
{
    /// <summary>
    /// Static methods for extracting <see cref="ImageSource"/> from files (.dll, .exe, .ico, .png, .jpg, etc.) directories, and handles.
    /// </summary>
    /// <remarks>
    /// You can convert System.Drawing.Icon types with ExtractFromHandle and the Icon's Handle.
    /// </remarks>
